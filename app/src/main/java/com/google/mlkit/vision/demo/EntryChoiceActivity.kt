...
class EntryChoiceActivity : AppCompatActivity(), ActivityCompat.OnRequestPermissionsResultCallback {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
   ...
   /* findViewById<TextView>(R.id.exercise_learn).setOnClickListener {
      val intent = Intent(this@EntryChoiceActivity, LearnableExerciseList::class.java)
      startActivity(intent)
    }
    findViewById<TextView>(R.id.timer_workout).setOnClickListener {
      val intent = Intent(this@EntryChoiceActivity, DynamicWorkoutPlan::class.java)
      startActivity(intent)
    } */
  ...
  /*  findViewById<TextView>(R.id.kotlin_entry_point).setOnClickListener {
   ...
   //just in the case permissions not granted than give them or ask them again to the user
